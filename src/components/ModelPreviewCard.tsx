    ...
    <div className="border border-gray-200 rounded-2xl p-4 bg-white">
      <div className="flex gap-3 items-start">
        ...
        <div className="flex-1">
          <h3 className="text-base font-semibold text-gray-900 mb-2">Model</h3>
          ...
          <div className="space-y-1.5">
            ...
            {/* Gender */}
            <div className="flex items-center">
              <span className="text-xs text-gray-500 w-20">Sex:</span>
              <span className="text-sm font-medium text-gray-900 capitalize">{gender}</span>
            </div>

            {/* Age Range */}
            <div className="flex items-center">
              <span className="text-xs text-gray-500 w-20">Age Range:</span>
              <span className="text-sm font-medium text-gray-900">{ageRange}</span>
            </div>
          </div>
        </div>
      </div>
