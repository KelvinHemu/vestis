    ...
    <div className="border border-gray-200 dark:border-gray-700 rounded-2xl p-3 sm:p-4 bg-white dark:bg-gray-800">
      <div className="flex gap-2 sm:gap-3 items-start">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2">Background</h3>
          ...
          <div className="space-y-0.5 sm:space-y-1.5">
            ...
            <div className="flex items-center">
              <span className="text-xs text-gray-500 dark:text-gray-400 w-14 sm:w-20">Type:</span>
              <span className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white capitalize truncate">{category}</span>
            </div>
          </div>
        </div>
      </div>
