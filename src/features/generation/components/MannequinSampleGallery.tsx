...
// Sample mannequin images
const SAMPLE_IMAGES = [
    { id: 'mannequin-1', image: '/sample/mannequin/image-1.jpg' },
    { id: 'mannequin-2', image: '/sample/mannequin/image-2.jpg' },
];

interface MannequinSampleGalleryProps {
    onSelectSample: (imageUrl: string) => void;
    selectedImage?: string;
}

export function MannequinSampleGallery({
    onSelectSample,
    selectedImage,
}: MannequinSampleGalleryProps) {
