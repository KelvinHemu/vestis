...
export const CheckoutPage: React.FC<CheckoutPageProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex overflow-hidden">
      ...
      <div className="hidden md:flex md:w-2/5 lg:w-1/2 bg-black dark:bg-gray-950 text-white flex-col justify-between p-8 lg:p-12">
        {/* Logo at Top */}
        <div>
          <img 
            src="/Vestis.svg" 
        ...
        <div>
          <p className="text-gray-500 dark:text-gray-400 text-sm uppercase tracking-wider mb-3">
            {selectedPackage.name} Plan
          </p>
          <div className="flex items-baseline">
            <span className="text-5xl lg:text-6xl font-light tracking-tight text-white">
      ...
      <div className="w-full md:w-3/5 lg:w-1/2 bg-white dark:bg-gray-900 flex flex-col">
        <div className="flex-1 flex flex-col justify-center px-8 py-12 lg:px-24">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="md:hidden mb-10 p-5 bg-black dark:bg-gray-950 text-white rounded-2xl">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">{selectedPackage.name} Plan</p>
            ...
            <div className="space-y-8">
              {/* Header */}
              <div>
                <h1 className="text-2xl font-light text-gray-900 dark:text-white">Contact information</h1>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black/5 dark:focus:ring-white/10 transition-all text-base font-light bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 ${
                      phoneError 
                        ? 'border-red-300 dark:border-red-700 focus:border-red-500' 
                        : 'border-gray-300 dark:border-gray-700 focus:border-gray-900 dark:focus:border-gray-500'
                    }`}
                  />
                </div>
                {phoneError && (
                  <p className="mt-2 text-sm text-red-500 dark:text-red-400 font-light">{phoneError}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 p-4 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800">
                  ...
                  <span className="text-sm font-normal text-gray-900 dark:text-white">Mobile Money</span>
              ...
              {error && (
                <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-100 dark:border-red-800">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-normal text-red-900 dark:text-red-200">Payment failed</p>
                      <p className="text-sm text-red-700 dark:text-red-300 mt-0.5 font-light">{error}</p>
                    </div>
                  </div>
                </div>
              )}
        ...
        <div className="px-8 py-6 lg:px-24 border-t border-gray-100 dark:border-gray-800">
          ...
          <div className="flex items-center justify-center gap-1 text-xs text-gray-400 dark:text-gray-500 font-light">
            <span>Powered by <span className="font-normal text-gray-600 dark:text-gray-300">Vestis</span></span>
