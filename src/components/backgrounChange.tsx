...
export function BackgroundChange() {
  ...
  }, [generatedImageUrl, storedGeneratedImageUrl, aspectRatio, setStoredGeneratedImageUrl, setIsEditMode, setAdditionalInfo, invalidateGenerations, invalidateBackgroundChangeCache]);
