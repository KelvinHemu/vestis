      ...
      `}>
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <input
            ...
            className="flex-1 bg-transparent border-none outline-none text-gray-900 placeholder-gray-400 text-base disabled:opacity-50"
          />
          ...
          <button 
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-900 hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            aria-label="Send"
          >
