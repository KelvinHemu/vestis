    ...
    <div className="border border-gray-200 rounded-2xl p-3 sm:p-4 bg-white">
      <div className="flex gap-2 sm:gap-3 items-start">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-1 sm:mb-2">Model</h3>
          ...
          <div className="space-y-0.5 sm:space-y-1.5">
            ...
            <div className="flex items-center">
              <span className="text-xs text-gray-500 w-14 sm:w-20">Sex:</span>
              <span className="text-xs sm:text-sm font-medium text-gray-900 capitalize">{gender}</span>
            </div>

            {/* Age Range */}
            <div className="flex items-center flex-wrap">
              <span className="text-xs text-gray-500 w-14 sm:w-20">Age:</span>
              <span className="text-xs sm:text-sm font-medium text-gray-900">{ageRange}</span>
            </div>
          </div>
        </div>
      </div>
